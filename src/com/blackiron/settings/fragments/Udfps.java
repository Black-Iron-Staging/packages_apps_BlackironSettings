/*
 * Copyright (C) 2019-2022 The Blackiron Projects
 *
...
import com.blackiron.settings.fragments.udfps.UdfpsIconPicker;
...
public class Udfps extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.blackiron_settings_udfps);

        final PreferenceScreen prefSet = getPreferenceScreen();
        Resources resources = getResources();

        final boolean udfpsResPkgInstalled = Utils.isPackageInstalled(getContext(),
                "com.blackiron.udfps.animations");
        ...
        final boolean udfpsResIconPkgInstalled = Utils.isPackageInstalled(getContext(),
                "com.blackiron.udfps.icons");
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.blackiron_settings_udfps);
}
